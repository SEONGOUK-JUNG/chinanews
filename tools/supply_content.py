...
COMPANY = {
    "en": "BRIDGE GROUP (ABridge Co., Ltd. · Ecobridge). Licensed trading company; state-trading rice quota holder under Korea's aT; supply contracts signed for SiC focus-ring CVD furnace systems with a Chinese semiconductor equipment maker (June 2026).",
    "ko": "BRIDGE GROUP(㈜에이브릿지 · ㈜에코브릿지). aT 쌀 국영무역 자격 보유 무역법인, 2026년 6월 SiC 포커스링 CVD 장비 대중(對中) 공급계약 체결.",
}
...
PAGES = [
    ...
    },
    {
        ...
        "en": {
            ...
            "desc": "Yttrium metal (ingot, sponge, sputtering-target grade 3N–4N) and high-purity yttrium oxide Y₂O₃ 4N–5N from China for semiconductor chamber coatings, YSZ ceramics, phosphors, YAG and Al–Y / Mg–Y alloys. Request a quote.",
        ...
        "ko": {
            "title": "산화이트륨 5N(Y₂O₃ 99.999%) 중국 직수입 공급 — 수출 허가·EUC 대행 | CHINANEWS",
            "desc": "산화이트륨(이트리아) Y₂O₃ 99.999% 5N 분말을 D50 1~2 / 3~4 / 5~7µm 세 가지 입도로 중국에서 직수입 공급합니다. HS 2846.90-1000, 1,000kg 단위. 반도체 챔버 코팅·YSZ·형광체·YAG용. 이중용도 수출 허가·EUC 서류 대행, 한국 내 통관·납품.",
            ...
            "table_head": ["제품", "규격", "순도", "주요 용도"],
            "faq": [
                ("5N은 실제로 어떤 의미인가요?", "Y₂O₃/TREO 99.999% 이상, 비희토류 불순물 합계가 보통 50ppm 미만입니다. 성적서 범위는 문의하실 때 협의합니다."),
        ...
        "rows": [
            ...
            ("Y₂O₃ 5N — in stock", "산화이트륨 5N — 공급 확정분", "99.999% · D50 1–2 / 3–4 / 5–7 µm · powder · HS 2846.90-1000 · from 1,000 kg", "99.999% · D50 1~2 / 3~4 / 5~7µm · 분말 · HS 2846.90-1000 · 1,000kg 단위", "99.999%", "Semiconductor chamber coatings, optical ceramics, single crystals", "반도체 챔버 코팅, 광학 세라믹, 단결정", []),
    ...
    },
    {
        ...
        "en": {
            ...
            "intro": [
                ...
                "In June 2026 ABridge signed supply contracts for SiC focus-ring CVD furnace systems with a Chinese semiconductor equipment maker; the same network supplies the materials below.",
            ],
        ...
        "ko": {
            ...
            "intro": [
                ...
                "㈜에이브릿지는 2026년 6월 SiC 포커스링 CVD 장비 공급계약을 중국 반도체 장비사와 체결했으며, 같은 네트워크로 아래 소재를 공급합니다.",
            ],
