...
PAGES = [
    ...
    },
    {
        ...
        "en": {
            ...
            "kicker": "Supply · RFQ",
            "intro": [
                "Available now. Yttrium oxide Y₂O₃ 99.999% (5N) powder in three particle sizes — D50 1–2, 3–4 and 5–7 µm. Priced per tonne with our Chinese producer and offered from 1,000 kg. HS code 2846.90-1000, ICP-MS certificate with every lot. Yttrium is under China's dual-use export controls: an export licence and an End-User Certificate are required. Count 45 Chinese business days from filing; we prepare the paperwork.",
            ...
            "faq": [
                ...
                ("Minimum order?", "The confirmed 5N grades (D50 1–2, 3–4, 5–7 µm) ship from 1,000 kg each. Other grades start at 25 kg (5N) and 50 kg (4N), with 500 g samples."),
        ...
        "ko": {
            ...
            "desc": "산화이트륨(이트리아) Y₂O₃ 99.999% 5N 분말을 D50 1~2 / 3~4 / 5~7µm 세 가지 입도로 중국에서 직수입 공급합니다. HS 2846.90-1000, 1톤 단위 단가 협의 완료. 반도체 챔버 코팅·YSZ·형광체·YAG용. 이중용도 수출 허가·EUC 서류 대행, ICP 성적서와 샘플 제공, 한국 내 통관·납품.",
            "h1": "산화이트륨(Y₂O₃) 5N 중국 직수입 공급",
            "kicker": "공급 · 견적",
            "intro": [
                "지금 공급 가능합니다. 산화이트륨 Y₂O₃ 99.999%(5N) 분말을 입도 세 가지(D50 1~2µm · 3~4µm · 5~7µm)로 공급합니다. 중국 생산자와 1톤 단위 단가 협의를 마쳤고, HS 코드 2846.90-1000으로 최소 1,000kg부터 주문받습니다. ICP-MS 성적서가 함께 나갑니다. 이트륨은 중국의 이중용도 품목 수출 통제 대상이라 수출 허가와 최종사용자확인서(EUC)가 필요합니다. 승인 접수일로부터 중국 영업일 기준 45일이 걸리며 서류는 저희가 준비합니다.",
